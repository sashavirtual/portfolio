...
const FacingIT = () => {
  return (
    <div className="sasha__facingIT section__padding reveal" id="facing-IT">
      <div className='sasha__facingIT-heading'>
        <h1 className='gradient__text'>How I ended up learning Front End Development and Web Design?</h1>
      </div>
      <div className='sasha__facingIT-container'>
